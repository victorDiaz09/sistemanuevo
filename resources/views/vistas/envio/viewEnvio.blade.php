...
<div class="modal-body bg-light">
    <form action="{{ route('envio.update', $datos->id_envio) }}" id="formMod" method="POST">
        ...
        <div class="form-group">
            <div class="input-group input-group-lg col-12">
                ...
                <input readonly required id="cod" type="number" placeholder="N° de orden de envío" name="numero_envio"
        ...
        <div>
            ...
            <div class="fl-flex-label mb-4 px-2 col-12 col-md-4">
                <input required type="number" placeholder="DNI / RUC" class="input input__text" name="dni_del_remitente"
                    value="{{ old('dni_del_remitente', $datos->dniRemitente) }}">
            ...
            <div class="fl-flex-label mb-4 px-2 col-12 col-md-8">
                <input type="text" placeholder="Dirección" class="input input__text" name="direccion_del_remitente"
        ...
        <div>
            ...
            <div class="fl-flex-label mb-4 px-2 col-12 col-md-8">
                <input required type="text" placeholder="Nombre o Razon Social" class="input input__text"
                    name="nombre_del_consignatario" value="{{ old('nombre_del_consignatario', $datos->nomReceptor) }}">
            ...
            <div class="fl-flex-label mb-4 px-2 col-12 col-md-4">
                <input type="number" placeholder="Teléfono" class="input input__text" name="telefono_del_consignatario"
            ...
            <div class="fl-flex-label mb-4 px-2 col-12 col-md-8">
                <input type="text" placeholder="Dirección" class="input input__text" name="direccion_del_consignatario"
        ...
        <div>
            ...
            <div>
                ...
                <div class="fl-flex-label mb-4 px-2 col-12 col-md-12">
                    <input type="text" class="input input__select" name="direccion_partida" placeholder="Dirección"
                        value="{{ old('direccion_partida', $datos->desde_direccion) }}">
        ...
        <div>
            ...
            <div>
                <div class="fl-flex-label mb-4 px-2 col-6 col-md-6">
                    ...
                    <input required class="input input__select" type="text" name="conductor"
                        value="{{ old('conductor', $datos->conductor) }}">
                    @error('conductor')
                    <p class="error-message text-danger">{{ $message }}</p>
                    @enderror
                </div>
                <div class="fl-flex-label mb-4 px-2 col-6 col-md-3">
                    <label class="title">Placas</label>
                    <input required class="input input__select" type="text" name="placas" value="{{ old('placas', $datos->placas) }}">
                    @error('placas')
                    <p class="error-message text-danger">{{ $message }}</p>
                    @enderror
                </div>
                <div class="fl-flex-label mb-4 px-2 col-6 col-md-3">
                    <label class="title">Placas</label>
                    <input required class="input input__select" type="text" name="placas2" value="{{ old('placas2', $datos->placas2) }}">
                    @error('placas2')
                    <p class="error-message text-danger">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="fl-flex-label mb-4 px-2 col-12 col-sm-6 col-md-3">
                    ...
                    <span style="color: rgb(21, 181, 0);font-size: 38px;"><i class="fas fa-toggle-on"></i></span>
                    @else
                ...
                <div class="fl-flex-label mb-4 px-2 col-12 col-md-9">
                    <textarea required name="descripcion" class="input input__select" rows="2"
                        placeholder="Descripcion">{{ old('descripcion', $datos->descripcion) }}</textarea>
                    @error('descripcion')
                    <p class="error-message text-danger">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="fl-flex-label mb-4 px-2 col-12 col-sm-6 col-md-3">
                    <label class="title">Fecha de Entrega</label>
    ...
    <div class="text-right p-2 d-flex justify-content-end flex-wrap gap-2 col-12">
        ...
        @if ($datos->pago_estado == '1')
        <form action="{{ route('eliminar.pago', $datos->id_envio) }}" method="get" class="d-inline formulario-noPagar">
        </form>
        <a class="btn btn-sm bg-success noPagar" data-id="{{ $datos->id_envio }}"><i class="fas fa-check"></i>
            PAGADO</a>
        @else
        <form action="{{ route('realizar.pago', $datos->id_envio) }}" method="get" class="d-inline formulario-pagar">
        </form>
        ...
        <a data-toggle="modal" data-target="#estadoEnvio" class="btn bg-primary"><i class="fas fa-people-carry"></i>
            {{ strtoupper($datos->nombre) }}</a>
        @else
        @if ($datos->envio_estado == '2')
        <a data-toggle="modal" data-target="#estadoEnvio" class="btn bg-warning"><i class="fas fa-car-side"></i>
            {{ strtoupper($datos->nombre) }}</a>
        @else
        @if ($datos->envio_estado == '3')
        <a data-toggle="modal" data-target="#estadoEnvio" class="btn bg-success"><i class="fas fa-check"></i>
            {{ strtoupper($datos->nombre) }}</a>
        @endif
        @endif
        @endif
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <a href="{{ route('estado.entregado', $datos->id_envio) }}" class="btn bg-success">ENTREGADO</a>
                    </div>
                </div>
            </div>
